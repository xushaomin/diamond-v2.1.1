...
<div class="con_right_main">
	 ...
	 <c:url var="postConfigUrl" value="/admin/save.do" />
	...
	<div class="con_search">
        ...
        <table class="add_list_table input tabContent">
            <tr>
                ...
                <td class="padT20"><input class="c_input_text text" type="text" name="dataId" value="${dataId}" maxlength="250" /></td>
            </tr>
            <tr>
                <th class="padT20">分组：</th>
                <td class="padT20"><input class="c_input_text text" type="text" name="group" value="${group}" maxlength="250" /></td>
            </tr>
            <tr>
                <th class="padT20">内容：</th>
                <td class="padT20">
                	<textarea class="c_textarea" style="width:90%;height:300px;" name="content">${content}</textarea>
                </td>
            </tr>
